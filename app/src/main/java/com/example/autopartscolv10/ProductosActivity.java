...
public class ProductosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaProductos.add(new Producto(1, "Rin de Lujo 15 in", 150000, R.drawable.rin2_round));
        listaProductos.add(new Producto(2, "Turbo Compresor", 1500000, R.drawable.turbo2_round));
        listaProductos.add(new Producto(3, "Asientos de Carreras", 500000, R.drawable.asiento2_round));
        listaProductos.add(new Producto(4, "Frenos de Disco", 400000, R.drawable.frenos2_round));
        ...
        for(Producto p: listaProductos){
            ...
            linearColumna.setBackgroundColor(getResources().getColor(R.color.Azul_Petroleo));
            ...
            txtProd.setTextColor(getResources().getColor(R.color.Amarillo));
            ...
            txtPrecio.setTextColor(getResources().getColor(R.color.teal_200));
